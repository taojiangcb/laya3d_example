...
declare namespace Matter {
    ...
    */
    export class Engine {
         ...
         * @param {engine} engine
         */
        static run(enige: Engine): Matter.Runner;
    ...
    */
    export class World extends Composite {
         ...
         * @returns world
         */
        static add(world: World, body: Body | Array<Body> | Composite | Array<Composite> | Constraint | Array<Constraint> | MouseConstraint | Array<any>): World;
